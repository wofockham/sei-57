...
showLocalMessage();
// console.log('I can still see the local message', localMessage); // crash: localMessage is out of scope.

// ES2015 added block scope -- why? /////////////////////////////////

// var inside inside a block
if (1000 > 3) {
...
// console.log('How many goldfish?', goldish); // crash: goldfish has gone out of scope
