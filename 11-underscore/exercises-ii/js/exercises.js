...
const firstLowerLetter = function (word) {
...
console.log('all words have more than 3 characters', _(words).every( moreThan3 ));

// - Check if some words are over twenty characters long
const moreThan20 = function (word) {
    return word.length > 20;
};
console.log('some words have more than 20 characters', _(words).some( moreThan20 ));
